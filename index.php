<?php
  ...
  $faqs = [
    ...
    [
      ...
      'answer' => "Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
      ...
      <p><a href=''>Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo."
    ],
    [
    ...
    [
      ...
      'answer' => "Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno.</p>
...
<body>
  ...
  <header>
    <section class="header-top">
      <div class="logo">
        <img src="assets/img/googlelogo.png" alt="logo">
  ...
  <main>
    <section class="main-container">
      <?php foreach($faqs as $faq) { ?>
        ...
        <div class="text"> <p><?php echo $faq['answer'] ?></p>  </div>
      <?php } ?>
    </section>
  </main>
  ...
  <footer>
    <div class="footer-container">
      ...
      <section class="footer-lang">
        ...
        <select name="Seleziona la lingua" id="">
